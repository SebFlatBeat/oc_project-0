...
public class ProductRepository {
    ...
    /**
     * Add products by setting id, quantity, price, name and descrpition
     */
    private static void generateProductData() {
        ...
        products.put(++id, new Product(id, 60, 59.00, "Google Home Mini", "Voice assistant"));
        products.put(++id, new Product(id, 70, 419.00, "SAMSUNG Galaxy S8", "Smartphone Android"));
    }
